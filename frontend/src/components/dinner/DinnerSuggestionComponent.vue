  ...
  setup() {
    const meals = [
      ...
      },
      {
        ...
        description:
          "A classic and elegant dish featuring a tender filet mignon wrapped in puff pastry and baked to perfection. Served with a delicious mushroom duxelles and prosciutto.",
        author: "Gordon Ramsay",
        servingSize: 6,
        difficulty: 4,
        thumbnailLink:
          "https://whatscookingrr.files.wordpress.com/2016/08/wp-image-1428485514jpeg.jpeg",
        cookTime: 90.0,
        recipeParts: [
          {
            recipePartId: 1,
            ...
            partDescription:
              "Step 1. Season the filet mignon generously with salt and pepper. In a hot skillet, sear all sides of the beef until browned. Remove from heat and let cool.",
            recipeItems: [
              {
                itemId: 1,
                quantity: 2,
          ...
          },
          {
            ...
            partDescription:
              "Step 2. In a food processor, pulse mushrooms until finely chopped. In a skillet, cook the mushrooms with minced shallots and garlic, seasoning with salt and pepper. Cook until all the moisture has evaporated. Remove from heat and let cool.",
            recipeItems: [
              {
                itemId: 2,
                quantity: 1,
          ...
          },
          {
            ...
            partDescription:
              "Step 3. Lay out a sheet of plastic wrap and place the prosciutto slices on it, overlapping slightly. Spread the cooled mushroom duxelles evenly over the prosciutto. Place the seared filet mignon in the center and roll the prosciutto around it, using the plastic wrap to help. Chill for 30 minutes.",
            recipeItems: [
              {
                itemId: 5,
                quantity: 6,
          ...
          },
          {
            ...
            partDescription:
              "Step 5. Bake the Beef Wellington in the preheated oven for 40-45 minutes, or until the pastry is golden brown and the internal temperature of the beef reaches 125°F for medium-rare. Remove from the oven and let rest for 10 minutes before slicing and serving.",
            recipeItems: [],
          },
        ],
